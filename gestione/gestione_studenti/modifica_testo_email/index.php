...
<?php
	...
	$result = $conn->query("SELECT testo_email FROM settings");
	$row = $result->fetch_assoc();
	$regolamento = $row["testo_email"];
?>
...
<body>
	<div class="container-fluid">
		...
		<div class="main" style="margin-top: 65px;">
			<h1>Modifica testo email</h1><br>
			<p>Inserire qui in questo form il testo che si vuole inviare tramite email, se si vogliono allegare le credenziali di accesso al quiz inserire i campi @username e @password nella posizione desiderata.</p>
			<p>Esempio:<br>
				I.   Credenziali – nome utente e password<br>
				&emsp;Nome utente: @username<br>
